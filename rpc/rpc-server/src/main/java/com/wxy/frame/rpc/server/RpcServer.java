...
import com.wxy.frame.rpc.common.codec.RpcDecoder;
import com.wxy.frame.rpc.common.codec.RpcEncoder;
import com.wxy.frame.rpc.common.util.StringUtil;
import com.wxy.frame.rpc.registry.api.ServiceRegistry;
...
public class RpcServer implements ApplicationContextAware, InitializingBean {
    ...
    private String serviceAddress;          //rpc服务地址
    ...
    public void afterPropertiesSet() throws Exception {
        ...
        try {
            ...
            logger.error("RpcServer 服务启动失败",e);
        }finally{
